...
consumer = pd.read_excel('/Users/rongnie/Desktop/Capstone/Updated data/Consumer Sentiment.xlsx')
finance = pd.read_excel('/Users/rongnie/Desktop/Capstone/Updated data/Financial.xlsx')
housing = pd.read_excel('/Users/rongnie/Desktop/Capstone/Updated data/Housing.xlsx')
inflation = pd.read_excel('/Users/rongnie/Desktop/Capstone/Updated data/Inflation.xlsx')
labor = pd.read_excel('/Users/rongnie/Desktop/Capstone/Updated data/Labor.xlsx')
production = pd.read_excel('/Users/rongnie/Desktop/Capstone/Updated data/Production.xlsx')
...
def display_inflation_section():
    ...
    dict_inf = {
        '1': "US PCE Index Market-Based Motor Vehicles and Parts SA",
        '2': "Consumer Price Index (mom %)",
        '3': "CPI ex-Food & Energy (mom %)"}
    ...
    data_df = pd.DataFrame(
        {
            "Name": ['US PCE Index Market-Based Motor Vehicles and Parts SA',
...
def display_labor_section():
    ...
    dict_inf = {
        '1':'U-3 US Unemployment Rate Total in Labor Force Seasonally Adjusted',
        '2':'US Employees on Nonfarm Payrolls Total SA',
        '3':'US Personal Income MoM SA',
        '4':'Nonagricultural Industries Usually Part Time Economic Reasons',
        '5':'Conference Board Employment Trends Index'}
    ...
    data_df = pd.DataFrame(
        {
            "Name": ['U-3 US Unemployment Rate Total in Labor Force Seasonally Adjusted',
...
for i in [6,7]: # Quarterly data
    f_l3 = f_l2
    
for i in [1,3,5]: # Monthly data
    avg3 = 0
    count = 0
    n=0
    while count<3:
    ...
    data_df = pd.DataFrame(
        {
            ...
            "Period":['MoM', 'WoW','MoM', 'WoW','MoM','QoQ','QoQ'],
